...
public class RequestParamController {
     ...
     */
    @ResponseBody
    @RequestMapping("/request-param-required")//필수로 입력해라(username을 입력안하면 에러)
     ...
     * Map(key=value), MultiValueMap(key=[value1, value2, ...]) ex) (key=userIds, value=[id1, id2])
     */
    @ResponseBody
     ...
     * String, int 같은 단순 타입 = @RequestParam & argument resolver(HttpServletRequest같은거) 로 지정해둔 타입 외 = @ModelAttribute
     */
    @ResponseBody
